...
int secp256k1_ecdsa_signature_parse_der(const secp256k1_context* ctx, secp256k1_ecdsa_signature* sig, const unsigned char *input, size_t inputlen) {
    ...
    if (secp256k1_ecdsa_sig_parse(&r, &s, input, inputlen, 1)) {
...
int secp256k1_ecdsa_signature_parse_ber_permissive(const secp256k1_context* ctx, secp256k1_ecdsa_signature* sig, const unsigned char *input, size_t inputlen) {
    secp256k1_scalar r, s;
    ...
    if (secp256k1_ecdsa_sig_parse(&r, &s, input, inputlen, 0)) {
        secp256k1_ecdsa_signature_save(sig, &r, &s);
        return 1;
    } else {
        memset(sig, 0, sizeof(*sig));
