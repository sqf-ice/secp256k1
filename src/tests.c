...
void run_ecmult_multi_tests(void) {
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 1);
        ...
        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 2);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
        ...
        secp256k1_ecmult(&ctx->ecmult_ctx, &r2, &pt[0], &sc[0], &sc[1]);
        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &sc[1], ecmult_multi_callback, &data, 1);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        for (j = 0; j < 3; j++) {
            for (i = 0; i < 32; i++) {
                ...
                secp256k1_gej_set_infinity(&pt[i]);
            }
            secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, sizes[j]);
            CHECK(secp256k1_gej_is_infinity(&r));
        }
        ...
        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 32);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    for (ncount = 0; ncount < count; ncount++) {
        ...
        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 20);
        secp256k1_gej_neg(&r2, &r2);
        secp256k1_gej_add_var(&r, &r, &r2, NULL);
        CHECK(secp256k1_gej_is_infinity(&r));
    }
    ...
    secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 6);
    secp256k1_ecmult_multi(&ctx->ecmult_ctx, &r, &szero, ecmult_multi_callback, &data, 5);
    CHECK(secp256k1_gej_is_infinity(&r));
            ...
            for(t1i = 0; t1i < TOP; t1i++) {
                ...
                for(s0i = 0; s0i < TOP; s0i++) {
                    for(s1i = 0; s1i < TOP; s1i++) {
                        ...
                        secp256k1_ecmult_multi(&ctx->ecmult_ctx, &actual, &szero, ecmult_multi_callback, &data, 2);
