...
static void secp256k1_ecmult_strauss(const secp256k1_ecmult_context *ctx, secp256k1_gej *r, int num, const secp256k1_gej *a, const secp256k1_scalar *na, const secp256k1_scalar *ng) {
    secp256k1_ge pre_a[STRAUSS_MAX_POINTS][ECMULT_TABLE_SIZE(WINDOW_A)];
#ifdef USE_ENDOMORPHISM
    secp256k1_ge pre_a_lam[STRAUSS_MAX_POINTS][ECMULT_TABLE_SIZE(WINDOW_A)];
#endif
    struct secp256k1_ecmult_point_state state[STRAUSS_MAX_POINTS];
     ...
     */
    if (no > 0) {
        secp256k1_gej prej[STRAUSS_MAX_POINTS][ECMULT_TABLE_SIZE(WINDOW_A)];
        secp256k1_fe zr[STRAUSS_MAX_POINTS][ECMULT_TABLE_SIZE(WINDOW_A)];
...
static void secp256k1_ecmult(const secp256k1_ecmult_context *ctx, secp256k1_gej *r, const secp256k1_gej *a, const secp256k1_scalar *na, const secp256k1_scalar *ng) {
    secp256k1_ecmult_strauss(ctx, r, 1, a, na, ng);
}
